...
// Note : This solution NOT works with any condition whether particular element repeats odd times or even times.
// It only works with  [2M + 1]. Now, in the given array/list, 'M' numbers  this condition.
